      ...
      <div className="flex flex-1 items-center justify-center bg-white p-6 transition-colors duration-300 dark:bg-slate-950 sm:p-12">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="lg:hidden flex items-center gap-2.5 mb-4">
            ...
            <h2 className="text-3xl font-extrabold text-surface-900 dark:text-slate-100">Welcome back</h2>
            <p className="mt-2 text-surface-500 dark:text-slate-400">Sign in to your account to continue</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5" id="login-form">
            ...
            {/* Password */}
            <div className="space-y-1.5">
              <label htmlFor="password" className="block text-sm font-medium text-surface-700 dark:text-slate-300">
                Password
              </label>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 text-sm text-surface-600 cursor-pointer dark:text-slate-400">
                <input
                  type="checkbox"
          ...
          <div className="relative">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-surface-200 dark:border-slate-800" />
            </div>
            <div className="relative flex justify-center text-sm">
              <span className="bg-white px-4 text-surface-400 dark:bg-slate-950 dark:text-slate-500">or continue with</span>
            </div>
          </div>

          {/* Social login */}
          <div className="grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 rounded-xl border border-surface-200 bg-white px-4 py-2.5 text-sm font-medium text-surface-700 transition-all hover:bg-surface-50 hover:border-surface-300 hover:shadow-sm">
