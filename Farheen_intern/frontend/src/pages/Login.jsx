        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              disabled={submitting}
              className="flex items-center justify-center gap-2 rounded-xl border border-surface-200 bg-white px-4 py-2.5 text-sm font-medium text-surface-700 transition-all hover:bg-surface-50 hover:border-surface-300 hover:shadow-sm disabled:opacity-50 dark:border-border-dark dark:bg-card-dark dark:text-body-dark dark:hover:bg-surface-dark"
            >
